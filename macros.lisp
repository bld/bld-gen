...
(defmacro defarithn (op &optional min-one-arg?)
  ...
  (let ((two-fun (two-fun op))
    ...
    `(progn
	 ...
	 (,cl-op arg1 arg2))
       (defmethod ,two-fun ((arg1 number) (arg2 ma))
	 (,two-fun (ma arg1) arg2))
       (defmethod ,two-fun ((arg1 ma) (arg2 number))
	 (,two-fun arg1 (ma arg2)))
...
(defmacro defarith2 (op)
  ...
  `(progn
     ...
     (defmethod ,op ((arg1 number) (arg2 number))
       (,(to-cl op) arg1 arg2))
     (defmethod ,op ((arg1 number) (arg2 ma))
       (,op (ma arg1) arg2))
     (defmethod ,op ((arg1 ma) (arg2 number))
       (,op arg1 (ma arg2)))
